...
import { Download, Calendar, User, TrendingUp, TrendingDown, Clock, CheckCircle, XCircle, AlertCircle } from 'lucide-react';
import {
...
/**
 * Editor Analytics Page Component
 *
 * Full page component for viewing individual editor performance analytics.
 * Includes metrics, charts, and recent claims history.
 *
 * @returns {JSX.Element}
 */
const EditorAnalyticsPage = () => {
  ...
  // Fetch analytics when editor or date range changes
  useEffect(() => {
  ...
  return (
    <div>
      <PageHeader title="Editor Analytics" />

      <div className="p-6 space-y-6">
        <p className="text-sm text-gray-600">
          View detailed performance metrics and productivity insights for individual editors
        </p>
        ...
        {!isLoading && !analytics && !error && (
          <div className="text-center py-12 bg-white rounded-lg border border-gray-200">
            ...
            <p className="text-gray-600">Select an editor to view analytics</p>
          </div>
        )}
      </div>
    </div>
