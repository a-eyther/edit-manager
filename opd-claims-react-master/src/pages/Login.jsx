      ...
      <div className="flex-1 bg-[#FAFBFC] flex items-center justify-center px-6 py-8 md:px-12 lg:px-20">
        <div className="w-full max-w-[90%] sm:max-w-[80%] md:max-w-[70%]">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              className="w-full bg-primary-500 text-white py-2.5 rounded-md text-[15px] font-medium hover:bg-primary-600 transition-colors mt-6 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              disabled={isLoading}
            >
              {isLoading ? (
                <>
