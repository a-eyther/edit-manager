...
const ActionBar = ({
  ...
  // An invoice is considered "handled" if it's either validated or invalidated
  const hasPendingInvoices = activeTab === 'digitisation' &&
    invoices.length > 0 &&
    (Object.keys(validatedInvoices).length + Object.keys(invalidInvoices).length) < invoices.length
